...
(function(process) {
  !function(t, e) {
    ...
    return function(t) {
      ...
      var w = i(10),
          ...
          j = 4e3,
          U = 5e3,
          X = "__flagInMainProcess",
          Y = "__hasGradientOrPatternBg",
          $ = "__optionUpdated",
          Q = /^[a-zA-Z0-9_]+$/;
        ...
        V(tt, function(t) {
          this._zr.on(t, function(e) {
            ...
            if ("globalout" === t)
              ...
              r && r.eventData && (i = E.extend({}, r.eventData));
      ...
      function o(t) {
        if (t.__hoverStlDirty) {
          ...
          var a = {};
          for (var s in o)
            o.hasOwnProperty(s) && (a[s] = t.style[s]);
      ...
      n.linearMap = function(t, e, i, n) {
        ...
        for (var i = -(1 / 0),
            n = 1,
            r = 0; r < t.length; ) {
          for (var o = t[r].interval,
              a = t[r].close,
              s = 0; s < 2; s++)
            o[s] <= i && (o[s] = i, a[s] = s ? 1 : 1 - n), i = o[s], n = a[s];
      ...
      u.normalizeToArray = function(t) {
        ...
        return l(e, function(t, n) {
          if (h(t)) {
            ...
            for (var r = 0; r < i.length; r++) {
              var o = i[r].exist;
              if (!(i[r].option || null != o.id && null != t.id || null == t.name || u.isIdInner(t) || u.isIdInner(o) || o.name !== t.name + ""))
                return i[r].option = t, void(e[n] = null);
            }
          }
        }), l(e, function(t, e) {
        ...
        l(t, function(t, i) {
          ...
          var n = t.exist,
              ...
              o = t.keyInfo;
          if (h(r)) {
            if (o.name = null != r.name ? r.name + "" : n ? n.name : "\0-", n)
              o.id = n.id;
            else if (null != r.id)
              o.id = r.id + "";
            else {
 ...
 while (e[o.id]);
        ...
        function i(t, e, i) {
          for (var n = 0,
              r = t.length; n < r; n++)
            for (var o = t[n].seriesId,
                a = u.normalizeToArray(t[n].dataIndex),
                s = i && i[o],
                l = 0,
                h = a.length; l < h; l++) {
              var c = a[l];
      ...
      n.prototype = {
        ...
        contain: function(t, e) {
          ...
          if (t = i[0], e = i[1], n.contain(t, e)) {
            ...
            if (r.hasStroke()) {
              ...
              if (l > 1e-10 && (r.hasFill() || (a = Math.max(a, this.strokeContainThreshold)), s.containStroke(o, a / l, t, e)))
                return !0;
            }
            if (r.hasFill())
              return s.contain(o, t, e);
          }
          return !1;
        },
        dirty: function(t) {
        ...
        var e = function(e) {
          ...
          if (i) {
            ...
            var r = this.shape;
            for (var o in i)
              !r.hasOwnProperty(o) && i.hasOwnProperty(o) && (r[o] = i[o]);
          }
      ...
      n.prototype = {
        ...
        getModel: function(t, e) {
          var i,
              a = null == t ? this.option : r(this.option, t = this.parsePath(t));
      ...
      u.box = n, u.vbox = r.curry(n, "vertical"), u.hbox = r.curry(n, "horizontal"), u.getAvailableSize = function(t, e, i) {
        ...
        if (s || l) {
          var c;
          if ("raw" === h)
            c = "group" === t.type ? new o(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
        ...
        y.type = "list", y.hasItemOption = !0, y.getDimension = function(t) {
          ...
          if (n) {
            for (var s = 1 / 0,
                ...
                h = 0,
                u = this.count(); h < u; h++)
              o = this.get(t, h, e), i && !i(o, t, h) || (o < s && (s = o), o > l && (l = o));
          ...
          for (var h = 0; h < l.length; h++) {
            var u;
            if (1 === s)
              u = e.call(r, this.get(t[0], h, i), h);
            else {
              for (var c = 0; c < s; c++)
                a[c] = this.get(t[c], h, i);
              a[c] = h, u = e.apply(r, a);
            }
            u && o.push(l[h]);
          }
      ...
      function u(t, e, i, n, r, a, s, l, h, u, c) {
        ...
        for (var _ = 0; _ < 1; _ += .05)
          I[0] = o(t, i, r, s, _), I[1] = o(e, n, a, l, _), g = x(A, I), g < y && (d = _, y = g);
        y = 1 / 0;
        for (var w = 0; w < 32 && !(v < M); w++)
          f = d - v, p = d + v, I[0] = o(t, i, r, s, f), I[1] = o(e, n, a, l, f), g = x(I, A), f >= 0 && g < y ? (d = f, y = g) : (C[0] = o(t, i, r, s, p), C[1] = o(e, n, a, l, p), m = x(C, A), p <= 1 && m < y ? (d = p, y = m) : v *= .5);
      ...
      function m(t, e, i, r) {
        if (t = h(t))
          return t = c(t), null != e && (t[0] = n(e)), null != i && (t[1] = a(i)), null != r && (t[2] = a(r)), y(u(t), "rgba");
      }
      function v(t, e) {
        if (t = h(t), t && null != e)
      ...
      var n = i(3),
          ...
          c = {};
      for (var d in h)
        h.hasOwnProperty(d) && (c[d] = new h[d]);
      var f = n.extendShape({
        type: "symbol",
        shape: {
          symbolType: "",
        ...
        buildPath: function(t, e, i) {
          ...
          g = {createSymbol: function(t, e, i, o, a, s) {
              var l = 0 === t.indexOf("empty");
              l && (t = t.substr(5, 1).toLowerCase() + t.substr(6));
              var h;
              return h = 0 === t.indexOf("image://") ? new n.Image({style: {
                  image: t.slice(8),
                  x: e,
                  y: i,
                  width: o,
                  height: a
                }}) : 0 === t.indexOf("path://") ? n.makePath(t.slice(7), {}, new r(e, i, o, a)) : new f({shape: {
                  symbolType: t,
                  x: e,
                  y: i,
                  width: o,
      ...
      _.prototype = {
        ...
        _dashedLineTo: function(t, e) {
          var i,
              ...
              m = h,
              y = a.length;
          for (u /= d, c /= d, o < 0 && (o = r + o), o %= r, g -= o * u, m -= o * c; u > 0 && g <= t || u < 0 && g >= t || 0 == u && (c > 0 && m <= e || c < 0 && m >= e); )
            n = this._dashIdx, i = a[n], g += u * i, m += c * i, this._dashIdx = (n + 1) % y, u > 0 && g < l || u < 0 && g > l || c > 0 && m < h || c < 0 && m > h || s[n % 2 ? "moveTo" : "lineTo"](u >= 0 ? f(g, t) : p(g, t), c >= 0 ? f(m, e) : p(m, e));
        ...
        _dashedBezierTo: function(t, e, i, r, o, a) {
          var s,
              ...
              w = p.length,
              M = 0;
          for (f < 0 && (f = d + f), f %= d, s = 0; s < 1; s += .1)
            l = x(m, t, i, o, s + .1) - x(m, t, i, o, s), h = x(y, e, r, a, s + .1) - x(y, e, r, a, s), _ += v(l * l + h * h);
          for (; b < w && (M += p[b], !(M > f)); b++)
            ;
          for (s = (M - f) / _; s <= 1; )
            u = x(m, t, i, o, s), c = x(y, e, r, a, s), b % 2 ? g.moveTo(u, c) : g.lineTo(u, c), s += p[b] / _, b = (b + 1) % w;
          ...
          u = o.extend({
            ...
            getTicks: function() {
              ...
              if (t) {
                ...
                e[0] < r[0] && i.push(e[0]);
                for (var a = r[0]; a <= r[1]; )
                  if (i.push(a), a = h(a + t, o), i.length > n)
                    return [];
              ...
              t && d(function(e) {
                if (t) {
                  ...
                  if (r.length && !n.length)
                    for (var o = 0,
                        a = r.length; o < a; o++)
                      "category" === r[o].get("type") && n.push(o);
      ...
      function l(t, e) {
        ...
        function n() {
          for (; y > 1; ) {
            var t = y - 2;
            if (t >= 1 && f[t - 1] <= f[t] + f[t + 1] || t >= 2 && f[t - 2] <= f[t] + f[t - 1])
              f[t - 1] < f[t + 1] && t--;
            else if (f[t] > f[t + 1])
              break;
            o(t);
 ...
 while ((f | g) < v);
        ...
        function h(i, n, r, o) {
          ...
          if (t[d--] = t[h--], 0 !== --n) {
            if (1 === o) {
              for (d -= n, h -= n, g = d + 1, f = h + 1, l = n - 1; l >= 0; l--)
                t[g + l] = t[f + l];
              return void(t[d] = x[u]);
            }
            for (var m = p; ; ) {
 ...
 while ((v | y) < m);
              ...
              do {
                if (v = n - s(x[u], t, i, n, n - 1, e), 0 !== v) {
                  for (d -= v, h -= v, n -= v, g = d + 1, f = h + 1, l = v - 1; l >= 0; l--)
                    t[g + l] = t[f + l];
                  if (0 === n) {
                    _ = !0;
                    break;
                ...
                if (y = o - a(t[h], x, 0, o, o - 1, e), 0 !== y) {
                  for (d -= y, u -= y, o -= y, g = d + 1, f = u + 1, l = 0; l < y; l++)
                    t[g + l] = x[f + l];
                  if (o <= 1) {
                    _ = !0;
                    break;
      ...
      function h(t, e, r, a) {
        ...
        if (!(s < 2)) {
          var h = 0;
          if (s < u)
            return h = n(t, r, a, e), void o(t, r, a, r + h, e);
          var c = new l(t, e),
              d = i(s);
          do {
            if (h = n(t, r, a, e), h < d) {
      ...
      n.prototype = {
        ...
        brush: function(t, e) {
          ...
          if (n.bind(t, this, e), i = "string" == typeof r ? this._image : r, !i && r) {
            ...
            if (i = o.image, this._image = i, !i.width || !i.height)
      ...
      c._createSymbol = function(t, e, i, n) {
        ...
        var o = t.getItemVisual(e, "symbol") || "circle",
            a = t.hostModel,
            s = n(t, e);
        if (o !== this._symbolType)
          this._createSymbol(o, t, e, s);
        else {
      ...
      v.type = "grid", v.getRect = function() {
        ...
        for (var n = 0,
            r = this._coordsList; n < r.length; n++)
      ...
      var s = a.prototype;
      s.updateView = s.updateLayout = s.updateVisual = function(t, e, i, n) {}, o.enableClassExtend(a), o.enableClassManagement(a, {registerWhenExtend: !0}), t.exports = a;
    }, function(t, e, i) {
      "use strict";
      var n = i(64),
          r = i(21),
      ...
      function u(t, e, i, n, r, o, a, s, l) {
        ...
        if (1 == l)
          for (var u = 0; u < h; u++)
            s[u] = c(t[u], e[u], i[u], n[u], r, o, a);
        else
          for (var d = t[0].length,
              u = 0; u < h; u++)
            for (var f = 0; f < d; f++)
              s[u][f] = c(t[u][f], e[u][f], i[u][f], n[u][f], r, o, a);
      }
      ...
      function p(t, e, i, n, r) {
        ...
        if (x) {
          ...
          if (!k) {
            for (var O = I[x - 1],
                L = 0; L < x - 1; L++)
              w ? l(I[L], O, T) : !isNaN(I[L]) || isNaN(O) || S || M || (I[L] = O);
            ...
            var W = function(t, e) {
              ...
              if (0 !== n)
                if (E = (e - A[i]) / n, v)
                  if (R = I[i], N = I[0 === i ? i : i - 1], B = I[i > x - 2 ? x - 1 : i + 1], V = I[i > x - 3 ? x - 1 : i + 2], w)
                    u(N, R, B, V, E, E * E, E * E * E, d(t, r), T);
                  else {
                    var l;
                    if (M)
                      l = u(N, R, B, V, E, E * E, E * E * E, H, 1), l = f(H);
                    else {
                      if (S)
                        return a(R, B, E);
                  ...
                  s(I[i], I[i + 1], E, d(t, r), T);
                else {
                  var l;
                  if (M)
                    s(I[i], I[i + 1], E, H, 1), l = f(H);
                  else {
                    if (S)
                      return a(I[i], I[i + 1], E);
                    l = o(I[i], I[i + 1], E);
                  }
                  p(t, r, l);
                }
 ...
 while (t);
      ...
      o.fromPoints = function(t, e, i) {
        if (0 !== t.length) {
          ...
          for (n = 1; n < t.length; n++)
            r = t[n], o = a(o, r[0]), l = s(l, r[0]), h = a(h, r[1]), u = s(u, r[1]);
      ...
      o.fromCubic = function(t, e, i, n, o, l, h, u, c, d) {
        ...
        var m = n.min,
            ...
            y = Math.abs(o - a);
        if (y % f < 1e-4 && y > 1e-4)
          return p[0] = t - i, p[1] = e - r, g[0] = t + i, void(g[1] = e + r);
        ...
        for (var _ = 0; _ < a; _ += Math.PI / 2)
          _ > o && (d[0] = h(_) * i + t, d[1] = l(_) * r + e, m(p, d, p), v(g, d, g));
      }, t.exports = o;
    }, function(t, e, i) {
      var n = i(36),
          r = i(1),
      ...
      a.prototype = {
        ...
        brush: function(t, e) {
          ...
          if (null != a && (a += ""), i.bind(t, this, e), a) {
            ...
            for (var c = o.measureText("国", t.font).width,
                d = a.split("\n"),
                f = 0; f < d.length; f++)
              i.hasFill() && t.fillText(d[f], n, r), i.hasStroke() && t.strokeText(d[f], n, r), r += c;
        ...
        drawRectText: function(t, e, i) {
          ...
          if (null != s && (s += ""), s) {
            ...
            for (var w = 0; w < b.length; w++)
              x && t.fillText(b[w], l, h), _ && t.strokeText(b[w], l, h), h += i.lineHeight;
            t.restore();
          }
        }
      }, t.exports = s;
      ...
      function r(t, e, i, r, o, a, g, m, v, y, x) {
        for (var _ = 0,
          ...
          if (b === i)
            t[a > 0 ? "moveTo" : "lineTo"](M[0], M[1]), c(f, M);
          else if (v > 0) {
            var S = b + a,
                T = e[S];
            if (x)
      ...
      t.exports = {
        Polyline: a.extend({
          ...
          buildPath: function(t, e) {
            ...
            for (; a < s; )
              a += r(t, i, a, s, s, 1, l.min, l.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1;
          }
        }),
        Polygon: a.extend({
          type: "ec-polygon",
      ...
      t.exports = {containStroke: function(t, e, i, n, r, o, a) {
          if (0 === r)
            return !1;
          var s = r,
              l = 0,
              h = t;
          if (a > e + s && a > n + s || a < e - s && a < n - s || o > t + s && o > i + s || o < t - s && o < i - s)
            return !1;
          if (t === i)
      ...
      var n = i(18);
      t.exports = {containStroke: function(t, e, i, r, o, a, s, l, h) {
          if (0 === s)
            return !1;
          var u = s;
          if (h > e + u && h > r + u && h > a + u || h < e - u && h < r - u && h < a - u || l > t + u && l > i + u && l > o + u || l < t - u && l < i - u && l < o - u)
            return !1;
      ...
      t.exports = {getBarItemStyle: function(t) {
          var e = n.call(this, t);
          ...
          if (this.__dirty || a.__dirty) {
            ...
            if (!n.ignore) {
              ...
              var f,
                  ...
                  m = 5 * r;
              if ("end" === n.__position)
                f = [c[0] * m + h[0], c[1] * m + h[1]], p = c[0] > .8 ? "left" : c[0] < -.8 ? "right" : "center", g = c[1] > .8 ? "top" : c[1] < -.8 ? "bottom" : "middle";
                ...
                f = [-c[0] * m + l[0], -c[1] * m + l[1]], p = c[0] > .8 ? "right" : c[0] < -.8 ? "left" : "center", g = c[1] > .8 ? "bottom" : c[1] < -.8 ? "top" : "middle";
              n.attr({
                style: {
      ...
      function s(t, e) {
        ...
        return e.mapArray([o], function(n, l) {
          for (var h,
              u = e.stackedOn; u && a(u.get(o, l)) === a(n); ) {
            h = u;
            break;
          }
          var c = [];
      ...
      function l(t, e, i) {
        ...
        var f = new v.Rect({shape: {
            x: s,
            y: l,
            width: h,
            height: u
          }});
        return e && (f.shape[a ? "width" : "height"] = 0, v.initProps(f, {shape: {
            width: h,
            height: u
          }}, i)), f;
      }
      ...
      t.exports = _.extend({
        ...
        _getSymbolIgnoreFunc: function(t, e) {
          ...
          if (i && i.isLabelIgnored)
            return f.bind(i.isLabelIgnored, i);
        },
      ...
      h.updateData = function(t, e, i) {
        ...
        s.updateProps(i, {shape: {points: h.linePoints || [[h.x, h.y], [h.x, h.y], [h.x, h.y]]}}, r, e), s.updateProps(n, {style: {
            x: h.x,
            y: h.y
          }}, r, e), n.attr({
          style: {
      ...
      function n(t, e, i, n, r, o, a) {
        function s(e, i, n, r) {
          for (var o = e; o < i; o++)
            if (t[o].y += n, o > e && o + 1 < i && t[o + 1].y > t[o].y + t[o].height)
              return void l(o, n / 2);
          l(i - 1, n / 2);
        }
        function l(e, i) {
        ...
        function h(t, e, i, n, r, o) {
          for (var a = o > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0,
              s = 0,
              l = t.length; s < l; s++)
        ...
        for (var u,
            ...
            p = [],
            g = 0; g < d; g++)
          u = t[g].y - c, u < 0 && s(g, d, -u, r), c = t[g].y + t[g].height;
        a - c < 0 && l(d - 1, c - a);
        for (var g = 0; g < d; g++)
        ...
        e.eachSeriesByType(t, function(t) {
          ...
          if (v.each("value", function(t, e) {
            ...
            if (A <= .001) {
              ...
              b = A / I, C = y, v.each("value", function(t, e) {
            ...
            _splitLine: function(t, e, i) {
              ...
              if (!n.isBlank()) {
                var a = t.getModel("splitLine"),
                    ...
                    c = l(a, i);
                u = r.isArray(u) ? u : [u];
                for (var d = e.coordinateSystem.getRect(),
                    f = n.isHorizontal(),
                    p = 0,
                    g = n.getTicksCoords(),
                    m = n.scale.getTicks(),
      ...
      function z(t, e, i) {
        ...
        if (t._track.push(t.group.transformCoordToLocal(r, o)), m(t) || h) {
          ...
          i && "single" === c.brushMode && c.removeOnClick && d(t, r, o) && p(t) && (n = {
            isEnd: i,
            removeOnClick: !0
          });
        return n;
              ...
              function e(e, r) {
                ...
                i[e] = [], n[e] = [], f(h, function(t, r) {
                  ...
                  if (u.assert(y(a) || o, "Empty component definition"), a) {
                    ...
                    o.mergeOption({}, this), o.optionUpdated({}, !1);
 ...
 while (i && 9 != i.nodeType && !(e = i === this.painterRoot));
        ...
        findHover: function(t, e, i) {
          for (var n = this.storage.getDisplayList(),
              r = n.length - 1; r >= 0; r--)
            if (!n[r].silent && n[r] !== i && !n[r].ignore && o(n[r], t, e))
              return n[r];
        }
      ...
      b.prototype = {
        ...
        eachBuildinLayer: function(t, e) {
          ...
          for (r = 0; r < o.length; r++)
            n = o[r], i = this._layers[n], i.isBuildin && t.call(e, i, n);
        },
        ...
        getRenderedCanvas: function(t) {
          ...
          for (var i = this.storage.getDisplayList(!0),
              n = {},
              r = 0; r < i.length; r++) {
            var o = i[r];
      ...
      s.prototype = {
        ...
        _update: function() {
          for (var t = (new Date).getTime() - this._pausedTime,
              e = t - this._time,
              i = this._clips,
              n = i.length,
              r = [],
      ...
      var n = i(63).normalizeRadian,
          r = 2 * Math.PI;
      t.exports = {containStroke: function(t, e, i, o, a, s, l, h, u) {
          if (0 === l)
            return !1;
          var c = l;
          h -= t, u -= e;
      ...
      var n = i(18);
      t.exports = {containStroke: function(t, e, i, r, o, a, s, l, h, u, c) {
          if (0 === h)
            return !1;
          var d = h;
          if (c > e + d && c > r + d && c > a + d && c > l + d || c < e - d && c < r - d && c < a - d && c < l - d || u > t + d && u > i + d && u > o + d && u > s + d || u < t - d && u < i - d && u < o - d && u < s - d)
            return !1;
      ...
      function o(t, e, i, n, o, a, s, l, h, u) {
        if (u > e && u > n && u > a && u > l || u < e && u < n && u < a && u < l)
          return 0;
      ...
      function l(t, e, i, r, l) {
        for (var u = 0,
          ...
          switch (b === h.M && _ > 1 && (i || (u += m(p, g, y, x, r, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
            ...
            case h.L:
              if (i) {
                if (v(p, g, t[_], t[_ + 1], e, r, l))
                  return !0;
              } else
                u += m(p, g, t[_], t[_ + 1], r, l) || 0;
              p = t[_++], g = t[_++];
              break;
            case h.C:
              if (i) {
                if (c.containStroke(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], e, r, l))
                  return !0;
              } else
                u += o(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], r, l) || 0;
              p = t[_++], g = t[_++];
              break;
            case h.Q:
              if (i) {
                if (d.containStroke(p, g, t[_++], t[_++], t[_], t[_ + 1], e, r, l))
                  return !0;
              } else
                u += a(p, g, t[_++], t[_++], t[_], t[_ + 1], r, l) || 0;
              p = t[_++], g = t[_++];
              break;
            case h.A:
              var w = t[_++],
              ...
              var P = (r - w) * T / S + w;
              if (i) {
                if (f.containStroke(w, M, T, A, A + I, C, e, P, l))
                  return !0;
              } else
                u += s(w, M, T, A, A + I, C, P, l);
            ...
            case h.R:
              ...
              var D = t[_++],
                  ...
                  L = x + O;
              if (i) {
                if (v(y, x, k, x, e, r, l) || v(k, x, k, L, e, r, l) || v(k, L, y, L, e, r, l) || v(y, L, y, x, e, r, l))
                  return !0;
              } else
                u += m(k, x, k, L, r, l), u += m(y, L, y, x, r, l);
              break;
            case h.Z:
              if (i) {
                if (v(p, g, y, x, e, r, l))
      ...
      h.prototype = {
        ...
        animate: function(t, e) {
          ...
          if (t) {
            ...
            i = a;
          if (!i)
            return void l('Property "' + t + '" is not existed in element ' + a.id);
          var f = a.animators,
              p = new n(i, e);
        ...
        _animateToShallow: function(t, e, i, n, o) {
          ...
          for (var h in i)
            if (i.hasOwnProperty(h))
              if (null != e[h])
                s(i[h]) && !r.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], i[h], n, o) : (a[h] = i[h], l++);
              else if (null != i[h])
                if (t) {
                  var u = {};
          ...
          l.each(s, function(t, e) {
            ...
            if (n) {
              ...
              var d = l.extend({}, n),
                  f = n.$action;
              if (f && "merge" !== f)
                "replace" === f ? r[e] = d : "remove" === f && i && (r[e] = null);
              else if (i) {
      ...
      function a(t, e, i, r, o) {
        ...
        if (isNaN(h) || isNaN(c)) {
          if (r.getMarkerPosition)
            a = r.getMarkerPosition(t.getValues(i, e));
          else {
            var d = t.get(i[0], e),
                f = t.get(i[1], e);
          ...
          f = function(t, e, i, n) {
            ...
            if (!l.isArray(n) && ("min" === o || "max" === o || "average" === o || null != n.xAxis || null != n.yAxis)) {
              ...
              if (null != n.yAxis || null != n.xAxis)
                s = null != n.yAxis ? "y" : "x", a = e.getAxis(s), h = l.retrieve(n.yAxis, n.xAxis);
              else {
      ...
      d.defaultOption = {
        ...
        if ("function" == typeof d) {
          ...
          h.appendChild(u), u.readOnly = r.get("readOnly"), u.style.cssText = "width:100%;height:100%;font-family:monospace;font-size:14px;line-height:1.6rem;", u.style.color = r.get("textColor"), u.style.borderColor = r.get("textareaBorderColor"), u.style.backgroundColor = r.get("textareaColor"), u.value = m.value;
        var x = m.meta,
        ...
        p.each(t.newOption.series, function(t) {
          ...
          if (n) {
            ...
            i.push(p.extend({type: "scatter"}, t));
      ...
      function u(t, e, i, n, r, o, a, u) {
        ...
        if (a && f.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], o, r.el, f)), p.isArray(t))
          e = y(t[0], c), i = y(t[1], d);
      ...
      i(2).extendComponentView({
        ...
        manuallyShowTip: function(t, e, i, n) {
          function r(t) {
            ...
            if (null != i && !p.isArray(i) && e.hasValue(i))
              return !0;
          }
          if (n.from !== this.uid) {
            var e = this._ecModel,
            ...
            if (null == n.x || null == n.y) {
              if (s ? (a && !r(a) && (a = null), a || e.eachSeries(function(t) {
                ...
                if (null == h || p.isArray(h))
                  return;
                var u,
                    d,
                    f = l.getItemGraphicEl(h),
        ...
        _tryShow: function(t) {
          ...
          if (i)
            if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
              ...
              "item" === n ? this._hide() : this._showAxisTooltip(i, r, t), "cross" === i.get("axisPointer.type") && o.dispatchAction({
                type: "showTip",
                from: this.uid,
                x: t.offsetX,
                y: t.offsetY
        ...
        _showAxisTooltip: function(t, e, i) {
          ...
          p.each(this._seriesGroupByAxis, function(e) {
            ...
            var d = s.getBaseAxis(),
                f = r.get("axis");
            if ("auto" === f && (f = d.dim), d.isBlank() || p.eqNaN(l[0]) || p.eqNaN(l[1]))
              return void this._hideAxisPointer(s.name);
            var g = !1,
                m = this._lastHover;
            if ("cross" === o)
              n(m.data, c) && (g = !0), m.data = c;
            else {
              var v = p.indexOf(u, f);
        ...
        _updateCrossText: function(t, e, i) {
          var n = i.getModel("crossStyle"),
              ...
              a = this._crossText;
          a || (a = this._crossText = new f.Text({style: {
              textAlign: "left",
        ...
        _dispatchAndShowSeriesTooltipContent: function(t, e, i, n, r, o) {
          ...
          if (e.length) {
            ...
            if (f.dispatchAction({
              ...
              if (r)
                u(o || a.get("position"), i[0], i[1], a.get("confine"), this._tooltipContent, v, null, f);
              else {
        ...
        u.prototype.brushVML = function(t) {
          ...
          if (r) {
            ...
            if (this.transform && (A = this.transform, L = m(A[0] * A[0] + A[1] * A[1]), D = m(A[2] * A[2] + A[3] * A[3]), k = A[1] || A[2]), k) {
              ...
              A && (h = h * L + A[4], u = u * D + A[5]), I.filter = "", I.left = g(h) + "px", I.top = g(u) + "px";
            var G = this._imageEl,
                W = this._cropEl;
            ...
            if (S) {
              if (e && i)
                Z.width = g(L * e * c / f) + "px", Z.height = g(D * i * d / v) + "px";
              else {
                var q = new Image,
                    j = this;
                q.onload = function() {
              ...
              Z.width = g(L * c) + "px", Z.height = g(D * d) + "px", T.appendChild(G), W && W.parentNode && (T.removeChild(W), this._cropEl = null);
            var X = "",
                Y = n.opacity;
        ...
        for (var $ = new r,
            Q = function(t, e, i, n) {
              ...
              if (null != o && (o += ""), o) {
                ...
                if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n)
                  a = e.x, l = e.y;
                else {
                  var v = r.textPosition,
                      y = r.textDistance;
                  if (v instanceof Array)
                    a = e.x + z(v[0], e.width), l = e.y + z(v[1], e.height), h = h || "left", d = d || "top";
                  else {
