...
"format cjs";
!function(e, t) {
  "object" == typeof exports && "object" == typeof module ? module.exports = t(require('../../index')) : "function" == typeof define && define.amd ? define(["echarts"], t) : "object" == typeof exports ? exports.dataTool = t(require('../../index')) : (e.echarts = e.echarts || {}, e.echarts.dataTool = t(e.echarts));
}(this, function(e) {
  return function(e) {
    function t(o) {
      if (r[o])
    ...
    o = function(e) {
      ...
      function u(e, t) {
        for (var r = e.firstChild,
            o = []; r; )
          r.nodeName.toLowerCase() == t.toLowerCase() && o.push(r), r = r.nextSibling;
        return o;
      }
      var s = r(1).util;
      return {parse: t};
