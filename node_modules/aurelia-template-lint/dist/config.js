...
class Config {
    constructor() {
        ...
        this.useRuleId = true; // error on bad id attributes
        this.useRuleValidChildren = true; // error on use of invalid child elements 
        this.useRuleRequiredAttributes = true; // error on missing attrs on tags
